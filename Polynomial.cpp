...
public:
	...
	// Default constructor
	Polynomial():numTerm(0),exponent(nullptr),coefficient(nullptr){}
	...
	// CopyConstructor
	Polynomial(const Polynomial& temp) {
		if (temp.numTerm) {
			numTerm = temp.numTerm;
			exponent = new int[numTerm];
			coefficient = new int[numTerm];
			for (int i = 0; i < numTerm; i++) {
				exponent[i] = temp.exponent[i];
				coefficient[i] = temp.coefficient[i];
			}
		}
	}
...
void polynomialReading(Polynomial& temp) {
	...
	cout << "Enter highest power of polynomial epression : ";
	cin >> num;
	while (num < 1) {
...
int main() {
	...
	Polynomial eq3 = eq1 + eq2;
	cout << "\n\nAddition of two polynomials: "
		<< "Expression1 + Expression2 =  " << eq3
		<<"\n***************************************************************************************" << endl<<endl;

	Polynomial eq4;
	eq4 = eq1 - eq2;
	cout << "\n\nSubtraction of two polynomials: "
		<< "Expression1 - Expression2 =  " << eq4
		<< "\n***************************************************************************************" << endl;
